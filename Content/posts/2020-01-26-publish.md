...
Publish worked seamlessly in this website creation process and provided all the convenience of Swift strong type system. Using well-known technology helped stay focused while trying to figure out not so familiar layout and styling techniques. Now that all the parts of the site are well understood, Publish together with Swift gives a lot of power for future improvements.
